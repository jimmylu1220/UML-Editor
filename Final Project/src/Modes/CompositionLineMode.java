...
import Line_Objects.Composition_Line;
...
public class CompositionLineMode extends Mode {
	...
	public void mouseReleased(MouseEvent e) {
		...
		if(StartGraphic_Index != -1 && EndGraphic_Index != -1) {
			lobj = new Composition_Line(draw_area.ObjectVector.elementAt(StartGraphic_Index), draw_area.ObjectVector.elementAt(EndGraphic_Index)
